...
import logo from "../../imges/avatar.jpeg";
      ...
      switch (name) {
        ...
        case "signup":
          if (eror?.status === 400) {
            ...
            notify("هذا الايميل مستخدم بالفعل");
          } else {
            setError("خطأ في الخادم الداخلي");
            notify("خطأ في الخادم الداخلي");
          }
